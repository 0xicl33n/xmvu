...
//@line 41 "c:\imvu\xulrunner\mozilla-central\xulrunner\setup\nsXULAppInstall.js"
...
const AppInstall = {
  ...
  installApplication : function ai_IA(aAppFile, aDirectory, aLeafName) {
    ...
    if (aDirectory == null) {
//@line 235 "c:\imvu\xulrunner\mozilla-central\xulrunner\setup\nsXULAppInstall.js"
      aDirectory = getDirectoryKey("ProgF");
      if (vendor)
        aDirectory.append(vendor);
//@line 251 "c:\imvu\xulrunner\mozilla-central\xulrunner\setup\nsXULAppInstall.js"
    }
    else {
    ...
    if (aLeafName == "") {
//@line 265 "c:\imvu\xulrunner\mozilla-central\xulrunner\setup\nsXULAppInstall.js"
      aLeafName = appName;
//@line 270 "c:\imvu\xulrunner\mozilla-central\xulrunner\setup\nsXULAppInstall.js"
    }
...
//@line 341 "c:\imvu\xulrunner\mozilla-central\xulrunner\setup\nsXULAppInstall.js"
...
//@line 348 "c:\imvu\xulrunner\mozilla-central\xulrunner\setup\nsXULAppInstall.js"
  }
};
